...
public class EventManager implements ThreadCompleteListener {
  ...
  private static final int MAX_RUNNING_EVENTS = 1000; // Just don't wanna have too many running events. :)
  private static final int MIN_ID = 1;
  private static final int MAX_ID = MAX_RUNNING_EVENTS;
  private static final int MAX_EVENT_TIME = 1800; // in seconds / 30 minutes.
  ...
  public int create(int eventTime)
    ...
    if (currentlyRunningSyncEvent != -1) {
      throw new InvalidOperationException(
          "Event [" + currentlyRunningSyncEvent
  ...
  public void statusOfAllEvents() {
    for (Object o : eventPool.entrySet()) {
      Entry pair = (Entry) o;
